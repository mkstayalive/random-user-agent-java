...
class RandomUser{
    ...
    companion object{
        var uaMap: HashMap<String, Array<String>> = HashMap()
        var freqMap: HashMap<String, Double> = HashMap()

        //Burdaki değişkenleri generate ile beraber static yapmaya çalışıyorum
        //Burdaki useragentları webdriver'da deneyip sahibindene detection olmamaya çalışacağım
